...
namespace T1809E_Project_Sem3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        // GET: Products
        public ActionResult Index(string sortOrder, int? status, string searchString, string currentFilter , int? page)
        {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Status,Thumbnails,Price,Discount,CreateAt,CategoryID,CreateById,UpdateById,DeleteById")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Status,Thumbnails,Price,Discount,CreateAt,CategoryID,CreateById,UpdateById,DeleteById")] Product product)
        {
            if (ModelState.IsValid)
            {
